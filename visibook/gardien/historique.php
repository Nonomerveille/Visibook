                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <!-- Bouton notifier -->
                                        <button onclick="envoyerNotification('<?php echo $row['personne_a_visiter']; ?>', 
                                        '<?php echo $row['date_jour']; ?>', '<?php echo $row['nom_utilisateur']; ?>', 
                                        '<?php echo $row['societe']; ?>', '<?php echo $row['objet']; ?>')">Notifier</button>
